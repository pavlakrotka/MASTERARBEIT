---
title: "Master's thesis: \"Model-based Adjustments for Non-concurrent Comparisons in Platform Trials\" "
author: "Pavla Krotka"
date: "2023"
output: 
  html_document:
...
This file contains all code to reproduce the figures presented in Chapter 3 and Plots from Appendix A.1 in the master's thesis *"Model-based Adjustments for Non-concurrent Comparisons in Platform Trials"*.
...
```{r, fig.width=10, fig.height=6}
ggarrange(ggplot(results_setting_4_alpha %>% filter(study_arm==3, bs_degree==3, unit_size==100)) +
            annotate("rect", xmin = -Inf, xmax = Inf, ymin = pred_int[1], ymax = pred_int[2], fill = "gray54", alpha = 0.4) +
            geom_line(aes(lambda1, reject_h0, color = as.factor(model))) +
            geom_point(aes(lambda1, reject_h0, color = as.factor(model))) +
            labs(x=TeX("$\\lambda$"), y="Type I error", color="Analysis approach:") +
          ...
          ggplot(results_setting_4_pow %>% filter(study_arm==3, bs_degree==3, unit_size==100)) +
            geom_line(aes(lambda1, reject_h0, color = as.factor(model))) +
            geom_point(aes(lambda1, reject_h0, color = as.factor(model))) +
            labs(x=TeX("$\\lambda$"), y="Power", color="Analysis approach:") +
            scale_color_manual(labels = c("Fixed - period", "Separate analysis", "Splines - period", "Splines - calendar"), values = my_palette, limits = force) +
...
```{r, fig.width=10, fig.height=15}
ggarrange(ggplot(results_setting_4_alpha %>% filter(bs_degree==3, unit_size==100)) +
            annotate("rect", xmin = -Inf, xmax = Inf, ymin = pred_int[1], ymax = pred_int[2], fill = "gray54", alpha = 0.4) +
            geom_line(aes(lambda1, reject_h0, color = as.factor(model))) +
            geom_point(aes(lambda1, reject_h0, color = as.factor(model))) +
            labs(x=TeX("$\\lambda$"), y="Type I error", color="Analysis approach:") +
          ...
          ggplot(results_setting_4_pow %>% filter(bs_degree==3, unit_size==100)) +
            geom_line(aes(lambda1, reject_h0, color = as.factor(model))) +
            geom_point(aes(lambda1, reject_h0, color = as.factor(model))) +
            labs(x=TeX("$\\lambda$"), y="Power", color="Analysis approach:") +
            scale_color_manual(labels = c("Fixed - period", "Separate analysis", "Splines - period", "Splines - calendar"), values = my_palette, limits = force) +
...
```{r, fig.width=10, fig.height=12}
ggarrange(ggplot(results_setting_4_alpha %>% filter(study_arm==3, bs_degree==3)) +
            annotate("rect", xmin = -Inf, xmax = Inf, ymin = pred_int[1], ymax = pred_int[2], fill = "gray54", alpha = 0.4) +
            geom_line(aes(lambda1, reject_h0, color = as.factor(model))) +
            geom_point(aes(lambda1, reject_h0, color = as.factor(model))) +
            labs(x=TeX("$\\lambda$"), y="Type I error", color="Analysis approach:") +
          ...
          ggplot(results_setting_4_pow %>% filter(study_arm==3, bs_degree==3)) +
            geom_line(aes(lambda1, reject_h0, color = as.factor(model))) +
            geom_point(aes(lambda1, reject_h0, color = as.factor(model))) +
            labs(x=TeX("$\\lambda$"), y="Power", color="Analysis approach:") +
            scale_color_manual(labels = c("Fixed - period", "Separate analysis", "Splines - period", "Splines - calendar"), values = my_palette, limits = force) +
...
```{r, fig.width=10, fig.height=12}
ggarrange(ggplot(results_setting_4_alpha %>% filter(study_arm==3, unit_size==100)) +
            annotate("rect", xmin = -Inf, xmax = Inf, ymin = pred_int[1], ymax = pred_int[2], fill = "gray54", alpha = 0.4) +
            geom_line(aes(lambda1, reject_h0, color = as.factor(model))) +
            geom_point(aes(lambda1, reject_h0, color = as.factor(model))) +
            labs(x=TeX("$\\lambda$"), y="Type I error", color="Analysis approach:") +
          ...
          ggplot(results_setting_4_pow %>% filter(study_arm==3, unit_size==100)) +
            geom_line(aes(lambda1, reject_h0, color = as.factor(model))) +
            geom_point(aes(lambda1, reject_h0, color = as.factor(model))) +
            labs(x=TeX("$\\lambda$"), y="Power", color="Analysis approach:") +
            scale_color_manual(labels = c("Fixed - period", "Separate analysis", "Splines - period", "Splines - calendar"), values = my_palette, limits = force) +
