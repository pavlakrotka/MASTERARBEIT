...
results_ii_eq_alpha <- sim_study_par(nsim = n_sim, scenarios = scenario_ii_eq_alpha, models = c("fixmodel", "fixmodel_cal", "sepmodel", "mixmodel", "mixmodel_cal"), endpoint = "cont")
write_csv(results_ii_eq_alpha, "results/results_ii_eq_alpha.csv")


#power.t.test(n=1000, sd=1, sig.level = 0.025, power=0.8, type = "two.sample", alternative = "one.sided")
...
results_ii_eq_pow <- sim_study_par_new(nsim = n_sim, scenarios = scenario_ii_eq_pow, models = c("fixmodel", "fixmodel_cal", "sepmodel", "mixmodel", "mixmodel_cal"), endpoint = "cont")
...
results_iii_eq_alpha <- sim_study_par(nsim = n_sim, scenarios = scenario_iii_eq_alpha, models = c("fixmodel", "fixmodel_cal", "sepmodel", "poolmodel"), endpoint = "cont")
...
results_iii_eq_pow <- sim_study_par(nsim = n_sim, scenarios = scenario_iii_eq_pow, models = c("fixmodel", "fixmodel_cal", "sepmodel", "poolmodel"), endpoint = "cont")
