...
scenario_iii_splines_eq_alpha <- data.frame(num_arms = 4, 
                                            n_arm = 250, 
                                            d1 = 250*0,
                                            d2 = 250*1,
                                            d3 = 250*2,
                                            ...
                                            trend = c(rep("linear", 27), rep("stepwise_2", 27), rep("stepwise", 27)),
                                            alpha = 0.025,
                                            ncc = TRUE,
                                            unit_size = 25,
                                            ci = FALSE,
...
results_iii_splines_eq_alpha <- sim_study_par(nsim = n_sim, scenarios = scenario_iii_splines_eq_alpha, models = c("splines", "splines_cal", "fixmodel", "fixmodel_cal"), endpoint = "cont")
write_csv(results_iii_splines_eq_alpha, "results/results_iii_splines_eq_alpha.csv")



scenario_iii_splines_eq_pow <- data.frame(num_arms = 4, 
                                          n_arm = 250, 
                                          d1 = 250*0,
                                          d2 = 250*1,
                                          d3 = 250*2,
...
results_iii_splines_eq_pow <- sim_study_par(nsim = n_sim, scenarios = scenario_iii_splines_eq_pow, models = c("splines", "splines_cal", "fixmodel", "fixmodel_cal"), endpoint = "cont")
write_csv(results_iii_splines_eq_pow, "results/results_iii_splines_eq_pow.csv")
