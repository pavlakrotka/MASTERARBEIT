...
- Discuss further scenarios to be considered

- Model other time trend patterns (inverted u, linear starting later during the trial, cyclic?)
...
- **Splines - assumptions:**
    - Equal time trends
    - Additivity assumption -> not anymore (?)
